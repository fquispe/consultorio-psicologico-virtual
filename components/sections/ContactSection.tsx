...
const ContactSection = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: 'Email',
      content: 'info@consultoriopsico.com',
      link: 'mailto:info@consultoriopsico.com',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section ref={ref} id="contacto" className="section-padding bg-gradient-to-br from-primary-50 via-white to-secondary-50">
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto">
            ...
            contigo lo antes posible para agendar tu cita.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                ...
                >
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-primary-500 to-secondary-600 rounded-lg flex items-center justify-center text-white flex-shrink-0 group-hover:scale-110 transition-transform">
                      {info.icon}
                    </div>
                    <div>
              ...
              <motion.div
                ...
                className="card bg-gradient-to-br from-primary-500 to-secondary-600 text-white"
              >
                <h3 className="font-heading font-bold text-xl mb-4">Horario de Atención</h3>
          ...
          >
            <div className="card">
              <h3 className="font-heading font-bold text-2xl mb-6 text-gray-900">
